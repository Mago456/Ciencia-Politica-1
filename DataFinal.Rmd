...
```{r}
Sis[,c(3,4,5,7)]=NULL
names(Sis) = c("Provincia", "Regiones", "Porcet-Sitieneseguro")
```
...
names(ProvinciasOrdenado) = c("Provincia", "Regiones", "Porcet-accesoagua")
...
#renombramos
```{r}
names(DataInternet) = c("Provincia", "Regiones", "Sitiene-acc-internet")
```
